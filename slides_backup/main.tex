...
to-do: How to explain the improvement to \textit{Kruskal} easily?
\end{frame}
...
\subsection{Simplification of Phase II?}% not really my work, but something which slowed me down...
...
\begin{itemize}
	\item Different Graph Formalisations\pause!\pause
