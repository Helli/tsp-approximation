...
%Which is, as mentioned, less than the cost of an optimal tour.
\end{frame}
...
\begin{itemize}
	...
	\item Tour: $\mathcal{O}(n)$ %This is the number of edges in the MST. We discuss later how we can arrange the edges in time linear to this.
\end{itemize}
...
\begin{isabelle}
	...
	\ algo{\isacharunderscore}sketch\ \isakeyword{where}\ {\isacartoucheopen}algo{\isacharunderscore}sketch\ {\isacharequal}\isanewline
	...
	\isamarkupcmt{it might save some steps to replace this with \isa{ind\ {\isacharparenleft}symhull\ E{\isacharparenright}}%
...
\begin{enumerate}
	...
	% I had to reorganise this one to get what I want without unnecessary assumptions.
